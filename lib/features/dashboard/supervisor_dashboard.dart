...
/// Tactical Supervisor Dashboard matching the design system.
    ...
    return SafeArea(
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Top Header: Greeting + Name & Supervisor Badge
            Row(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildMetricItem('4', 'Total', Colors.white),
                      Container(
                          width: 1, height: 28, color: const Color(0xFF1E293B)),
                      _buildMetricItem('3', 'Synced', const Color(0xFF10B981)),
                      Container(
                          width: 1, height: 28, color: const Color(0xFF1E293B)),
                      _buildMetricItem('1', 'Pending', const Color(0xFFF59E0B)),
                      Container(
                          width: 1, height: 28, color: const Color(0xFF1E293B)),
                      _buildMetricItem('3', 'Verified', const Color(0xFF38BDF8)),
                    ],
                  ),
